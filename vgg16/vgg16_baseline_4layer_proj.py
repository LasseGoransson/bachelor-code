...
# select project
neptune.init('lassegoransson/xrayPredictor-vgg16')
...
# Model
VGG16 = keras.applications.VGG16(include_top=False, weights='imagenet', input_shape=(image_height,image_width,3), pooling="avg")
