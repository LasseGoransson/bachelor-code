...
checkpointpath = "/home/lasg/bachelor-data/checkpoints/"
...
# Projection
model.add(Conv2D(3,(1,1),kernel_regularizer=keras.regularizers.l2(0.0001),input_shape=(image_height,image_width,1)))
