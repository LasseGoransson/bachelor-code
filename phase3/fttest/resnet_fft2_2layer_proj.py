...
train_path = "/home/lasg/bachelor-data/allTrain.csv"
validate_path ="/home/lasg/bachelor-data/allTest.csv"

image_dir = "/home/lasg/bachelor-data/data_320x515_extentW/"
checkpointpath = "/home/lasg/bachelor-data/fftcheck/"
...
# Projection
#model.add(Conv2D(3,(1,1),input_shape=(image_height,image_width,1)))
...
model = tf.keras.models.load_model("/home/lasg/bachelor-data/fftcheck/fft_phase1.hdf5", custom_objects={'Activation': tf.keras.layers.Activation})
...
filepath=str(checkpointpath)+"fft_phase1"+".hdf5"
