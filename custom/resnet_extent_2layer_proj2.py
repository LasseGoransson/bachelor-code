...
# Model
RESNET = keras.applications.resnet.ResNet50(include_top=False, weights='imagenet', input_shape=(image_height-2,image_width-2,3), pooling="avg")
...
# Projection
model.add(Conv2D(3,(3,3),input_shape=(image_height,image_width,1)))
