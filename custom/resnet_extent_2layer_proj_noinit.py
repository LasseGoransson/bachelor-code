...
image_dir = "../../bachelor-data/data_320x515_extentW_gradient/"
...
# Model
RESNET = keras.applications.resnet.ResNet50(include_top=False, weights=None, input_shape=(image_height,image_width,3), pooling="avg")
